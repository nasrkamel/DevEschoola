document.addEventListener("DOMContentLoaded", function () {
  ...
  var positionStickySupport = function positionStickySupport() {
  ...
  var skrollrStart = function skrollrStart() {
    var elH = scrollslider.offsetHeight;
  ...
  var mobileScrolling = function mobileScrolling() {
    var elOffset = overlays.getBoundingClientRect();
    var top = Math.ceil(elOffset.top / 5) * 5;
    var halfOfViewport = Math.ceil(Math.floor(viewportHeight / 2) / 5) * 5;
